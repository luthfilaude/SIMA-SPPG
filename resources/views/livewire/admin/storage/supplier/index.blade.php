<div>
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <button wire:click="create" class="btn btn-primary" data-toggle="modal"
                                data-target="#createSupplierModal"><i class="fas fa-plus mr-2"></i>Tambah
                                Supplier</button>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button wire:click='edit({{ $item->id }})' data-toggle="modal"
                                                data-target="#editSupplierModal" class="btn btn-sm btn-warning"><i
                                                    class="fas fa-edit"></i></button>
                                            <button wire:click='supplierConfirm({{ $item->id }})'
    ...
    @include('livewire.admin.storage.supplier.create')
    @script
        <script>
    ...
    @endscript
    @include('livewire.admin.storage.supplier.edit')
    @script
        <script>
    ...
    @endscript
    @include('livewire.admin.storage.supplier.delete')
    @script
        <script>
