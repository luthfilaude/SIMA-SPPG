<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="editSupplierModal" tabindex="-1" aria-labelledby="editSupplierModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editSupplierModalLabel"><i class="fas fa-edit mr-1"></i>Edit
                        {{ $title }}
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">
                            ...
                            Tutup</button>
                        <button wire:click="update({{ $supplier_id }})" type="button" class="btn btn-warning btn-sm">
